// enriched-markdown needs concrete style values, not NativeWind classes — resolve design-system tokens here.
...
function buildMarkdownStyle(scheme: "light" | "dark"): MarkdownStyle {
  ...
  // Fenced code has no design-system token; use Atom One's flat base color (no per-token highlighting).
