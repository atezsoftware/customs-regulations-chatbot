...
- `FS_EXPLORER_RERANK_TIMEOUT_SECONDS` (optional, `core-api`, default 8) — HTTP timeout for one rerank call; a timeout is treated the same as any other rerank failure (falls back to the heuristic ranker)
