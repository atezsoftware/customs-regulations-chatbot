...
# OpenSearch applies the first rule for 3-5 analyzed terms and the second for
    ...
    def _get_search_filters(
        ...
        def _get_validity_filter(as_of_date: date) -> dict[str, Any]:
            ...
            started_clause = {
                "bool": {
                    "should": [
                        {
                            "range": {
                                VALIDITY_START_DATE_FIELD_NAME: {"lte": as_of_epoch}
                            }
                        },
                        {
                            "bool": {
            ...
            not_ended_clause = {
                "bool": {
                    "should": [
                        {"range": {VALIDITY_END_DATE_FIELD_NAME: {"gt": as_of_epoch}}},
                        {
                            "bool": {
                                "must_not": {
