...
class HybridCapable(abc.ABC):
    ...
    def keyword_retrieval(
        ...
        Args:
            ...
            high_term_coverage: When True, require a substantial majority of
                analyzed query terms in the full-text match. Backends that
                cannot express this may fall back to normal keyword behavior.
