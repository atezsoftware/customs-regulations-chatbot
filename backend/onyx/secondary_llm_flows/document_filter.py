...
_CONTEXT_EXPANSION_CLASSIFICATION_MAX_TOKENS = 16
_SECTION_SELECTION_MAX_TOKENS = 64
    ...
    try:
        ...
        with llm_generation_span(
            ...
            response = llm.invoke(
                ...
                max_tokens=_CONTEXT_EXPANSION_CLASSIFICATION_MAX_TOKENS,
            )
    ...
    try:
        with llm_generation_span(
            ...
            response = llm.invoke(
                ...
                reasoning_effort=ReasoningEffort.OFF,
                timeout_override=SECONDARY_LLM_FLOW_TIMEOUT_S,
                max_tokens=_SECTION_SELECTION_MAX_TOKENS,
            )
            record_llm_response(span_generation, response)
            llm_response = response.choice.message.content
