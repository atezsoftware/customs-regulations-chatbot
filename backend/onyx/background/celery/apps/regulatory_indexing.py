...
from onyx.configs.constants import POSTGRES_CELERY_WORKER_REGULATORY_INDEXING_APP_NAME
...
celery_app.config_from_object("onyx.background.celery.configs.regulatory_indexing")
...
def on_worker_init(sender: Worker, **kwargs: Any) -> None:
    ...
    SqlEngine.set_app_name(POSTGRES_CELERY_WORKER_REGULATORY_INDEXING_APP_NAME)
