...
celery_app.config_from_object("onyx.background.celery.configs.regulatory_benchmark")
...
def on_worker_init(sender: Worker, **kwargs: Any) -> None:
    ...
    SqlEngine.set_app_name(POSTGRES_CELERY_WORKER_REGULATORY_BENCHMARK_APP_NAME)
