...
def _transform_vespa_document_sets_to_elasticsearch_document_sets(
...
def _transform_vespa_acl_to_elasticsearch_acl(
...
def transform_vespa_chunks_to_elasticsearch_chunks(
    ...
    for vespa_chunk in vespa_chunks:
        try:
            ...
            # and we don't want this in Elasticsearch; whatever restrictions there
            ...
            document_sets: list[str] | None = (
                _transform_vespa_document_sets_to_elasticsearch_document_sets(
            ...
            is_public, acl_list = _transform_vespa_acl_to_elasticsearch_acl(
            ...
            elasticsearch_chunk = DocumentChunk(
            ...
            result.append(elasticsearch_chunk)
        except Exception:
            traceback.print_exc()
            logger.exception(
                "Migration error: Error transforming Vespa chunk with document ID %s and chunk index %s into an Elasticsearch chunk. Continuing with the migration...",
