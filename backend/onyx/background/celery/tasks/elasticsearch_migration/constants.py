...
# Constants corresponding to migrate_documents_from_vespa_to_elasticsearch_task.
from onyx.configs.app_configs import ELASTICSEARCH_MIGRATION_GET_VESPA_CHUNKS_PAGE_SIZE
...
# Constants corresponding to check_for_documents_for_elasticsearch_migration_task.
...
# be made to ElasticsearchTenantMigrationRecord.
GET_VESPA_CHUNKS_PAGE_SIZE = ELASTICSEARCH_MIGRATION_GET_VESPA_CHUNKS_PAGE_SIZE
