...
class ChunkerProtocol(Protocol):
    """What the indexing pipeline needs from a chunker implementation.

    Satisfied by `Chunker` (token-window sentence chunking) and
    `RegulatoryIndexingChunker` (structure-aware regulatory chunking for user
    files).
    """
