...
regions explicitly. Do not guess missing text. Return each box as an object with
exactly four named numeric coordinates: left, top, right, bottom. Origin is top
left; all coordinates must be finite and within [0,1], with left < right and
top < bottom. Do not return coordinate arrays. Do not omit unreadable regions.
