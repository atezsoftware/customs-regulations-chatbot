...
class LLMFlow(StrEnum):
    ...
    REGULATORY_ANNEX_CORRECTION = "regulatory_annex_correction"
    REGULATORY_ANNEX_EFFECTIVE_DATE = "regulatory_annex_effective_date"
    REGULATORY_ANNEX_COMPARISON = "regulatory_annex_comparison"
    ...
    REGULATORY_LABELING_BATCH = "regulatory_labeling_batch"
    ...
    # Regulatory amendment (update) pipeline
    AMENDMENT_SEGMENTATION = "amendment_segmentation"
    AMENDMENT_MATCH_CONFIRMATION = "amendment_match_confirmation"
    AMENDMENT_DRAFTING = "amendment_drafting"
    REGULATORY_REQUEST_INVENTORY = "regulatory_request_inventory"
    REGULATORY_COVERAGE_PLAN = "regulatory_coverage_plan"
    REGULATORY_COVERAGE_GAP_AUDIT = "regulatory_coverage_gap_audit"
    REGULATORY_EVIDENCE_MATRIX = "regulatory_evidence_matrix"
    REGULATORY_NAVIGATION_RECOVERY = "regulatory_navigation_recovery"
    REGULATORY_ANSWER_AUDIT = "regulatory_answer_audit"
