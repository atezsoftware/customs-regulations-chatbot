# Named `platform_utils` (not `platform`) so this module cannot shadow the stdlib
# `platform` if this package directory is placed on `sys.path[0]` by a direct script.
import os
import warnings
