...
class RegulatoryChunkSource(str, PyEnum):
    """Where a regulatory chunk came from: the indexing pipeline (RegulatoryChunker
    over a user file) or an approved amendment proposal."""
...
class RegulatoryIndexingSubmissionState(str, PyEnum):
    ...
    RETRY_CLEANUP_REQUIRED = "RETRY_CLEANUP_REQUIRED"
    SUBMITTED = "SUBMITTED"
