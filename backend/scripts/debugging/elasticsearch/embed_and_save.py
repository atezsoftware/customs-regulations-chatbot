...
Usage:
    ...
    python backend/scripts/debugging/elasticsearch/embed_and_save.py --help
"""
...
from scripts.debugging.elasticsearch.embedding_io import save_query_embedding_to_file
