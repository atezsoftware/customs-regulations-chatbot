...
from shared_configs.configs import DISABLE_ONYX_UPSTREAM_CONNECTIONS
...
POSTHOG_API_KEY = (
    ...
    else os.environ.get("POSTHOG_API_KEY")
)
...
MARKETING_POSTHOG_API_KEY = (
    None
    if DISABLE_ONYX_UPSTREAM_CONNECTIONS
    else os.environ.get("MARKETING_POSTHOG_API_KEY")
)

HUBSPOT_TRACKING_URL = (
    None
    if DISABLE_ONYX_UPSTREAM_CONNECTIONS
    else os.environ.get("HUBSPOT_TRACKING_URL")
)
