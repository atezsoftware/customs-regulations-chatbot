"""Tests for Elasticsearch search Prometheus metrics."""
...
class TestRecordElasticsearchSearchError:
    def test_increments_error_counter_with_exception_class_name(self) -> None:
        ...
        # Under test.
        record_elasticsearch_search_error(search_type, ValueError("boom"))
    ...
    def test_distinguishes_error_types(self) -> None:
        ...
        # Under test.
        record_elasticsearch_search_error(search_type, ValueError("a"))
        record_elasticsearch_search_error(search_type, RuntimeError("b"))
...
class TestObserveElasticsearchSearch:
    def test_does_not_increment_attempt_counter(self) -> None:
        # Precondition.
        # observe_elasticsearch_search must not touch _search_total; the attempt
        # counter is the responsibility of record_elasticsearch_search_attempt so
        # that failures count toward the denominator.
        search_type = ElasticsearchSearchType.HYBRID
        before = _search_total.labels(search_type=search_type.value)._value.get()

        # Under test.
        observe_elasticsearch_search(search_type, 0.1, 50)
    ...
    def test_observes_client_duration(self) -> None:
        ...
        # Under test.
        observe_elasticsearch_search(search_type, 0.25, 100)
    ...
    def test_observes_server_duration(self) -> None:
        ...
        # Under test.
        observe_elasticsearch_search(search_type, 0.3, 200)
    ...
    def test_server_took_none_skips_server_histogram(self) -> None:
        # Precondition.
        search_type = ElasticsearchSearchType.UNKNOWN
        ...
        # Under test.
        observe_elasticsearch_search(search_type, 0.1, None)
    ...
    def test_observes_overhead_when_both_durations_known(self) -> None:
        ...
        observe_elasticsearch_search(search_type, 0.5, 200)
    ...
    def test_overhead_drops_negative_observation(self) -> None:
        ...
        # timekeeping bug on the Elasticsearch side), the raw diff is negative. The
        ...
        observe_elasticsearch_search(search_type, 0.1, 500)
...
class TestTrackElasticsearchSearch:
    def test_gauge_increments_and_decrements(self) -> None:
        ...
        # Under test.
        with track_elasticsearch_search(search_type):
