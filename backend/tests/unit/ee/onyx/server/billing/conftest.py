...
def allow_upstream_for_billing_unit_tests(monkeypatch: pytest.MonkeyPatch) -> None:
    """Individual request tests exercise the opt-in billing implementation."""
    monkeypatch.setattr(
        "ee.onyx.server.billing.service.DISABLE_ONYX_UPSTREAM_CONNECTIONS",
        False,
    )
