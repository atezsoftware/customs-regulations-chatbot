...
def test_provider_module_import_does_not_require_playwright(
    ...
    module_name = "onyx.tools.tool_implementations.web_search.providers"
    crawler_module_name = "onyx.tools.tool_implementations.open_url.onyx_web_crawler"
    monkeypatch.setattr(builtins, "__import__", import_without_playwright)
    sys.modules.pop(module_name, None)
    sys.modules.pop(crawler_module_name, None)

    importlib.import_module(module_name)

    assert crawler_module_name not in sys.modules
