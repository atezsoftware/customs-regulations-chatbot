...
from onyx.document_index.elasticsearch.port_copy import (
...
@patch("onyx.document_index.elasticsearch.port_copy.re_embed_chunks")
...
@patch("onyx.document_index.elasticsearch.port_copy._PORT_WRITE_PAGE_SIZE", 2)
@patch("onyx.document_index.elasticsearch.port_copy.re_embed_chunks")
...
@patch("onyx.document_index.elasticsearch.port_copy.USE_DOCUMENT_SUMMARY", False)
@patch("onyx.document_index.elasticsearch.port_copy.USE_CHUNK_SUMMARY", True)
@patch("onyx.document_index.elasticsearch.port_copy.re_embed_chunks")
...
@patch("onyx.document_index.elasticsearch.port_copy.USE_DOCUMENT_SUMMARY", True)
@patch("onyx.document_index.elasticsearch.port_copy.USE_CHUNK_SUMMARY", False)
@patch("onyx.document_index.elasticsearch.port_copy.re_embed_chunks")
