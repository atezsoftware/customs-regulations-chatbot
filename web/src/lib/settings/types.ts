...
export interface Settings {
  ...
  // Atez Customs Assistant Craft (Build Mode) feature flag
...
export interface EnterpriseSettings {
  ...
  // Hide the "Powered by Atez Customs Assistant" tagline under the sidebar logo.
...
export interface AppSettings extends Settings {
  ...
  /** Resolved display name: enterprise.application_name || "Atez Customs Assistant". */
  appName: string;
  /**
   * URL of the logo image to render, or `null` to use the default Atez Customs Assistant SVG.
