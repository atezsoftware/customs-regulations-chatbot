...
/** Product name shown wherever no enterprise white-label name is configured. */
export const DEFAULT_APPLICATION_NAME = "Atez Customs Assistant";

export const APP_SLOGAN = "Customs Knowledge Assistant";
