...
//
// frame-ancestors controls who may embed Atez Customs Assistant in an <iframe>. On by default;
// WEB_FRAME_PROTECTION_ENABLED=false drops it so any origin may frame Atez Customs Assistant.
