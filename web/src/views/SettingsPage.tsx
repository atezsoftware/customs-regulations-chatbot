    ...
    <Section gap={2}>
      <Section gap={0.75}>
        ...
        <Card>
          <InputHorizontal
            title="Default Model"
            description="This model will be used by Atez Customs Assistant by default in your chats."
            withLabel
          >
            <ModelSelector
              value={
      ...
      <Section gap={0.75}>
        ...
        <Card>
          <InputHorizontal
            ...
            description="Let Atez Customs Assistant reference stored memories in chats."
            withLabel
          >
            <Switch
          ...
          <InputHorizontal
            ...
            description="Let Atez Customs Assistant generate and update stored memories."
            withLabel
          >
            <Switch
    ...
    <>
      ...
      {tokenToDelete && (
        ...
        >
          <Section gap={0.5} alignItems="start">
            <Text color="text-05">
              {`Any application using the token ${tokenToDelete.name} (${tokenToDelete.token_display}) will lose access to Atez Customs Assistant. This action cannot be undone.`}
            </Text>
            <Text color="text-05">
    ...
    <>
      {showDisconnectConfirmation && (
        ...
        >
          <Section gap={0.5} alignItems="start">
            <Text color="text-05">
              {`Atez Customs Assistant will no longer be able to access or search content from your ${sourceMetadata.displayName} account.`}
            </Text>
            <Text color="text-05">
