...
export default function CraftPage() {
  ...
  const header = (
    <SettingsLayouts.Header
      ...
      description="Control who can use Craft, Atez Customs Assistant's agentic app builder."
      divider
    />
  );
      ...
      <SettingsLayouts.Root>
        ...
        <SettingsLayouts.Body>
          <IllustrationContent
            ...
            description="Craft is enabled per deployment by Atez Customs Assistant. Contact your Atez Customs Assistant representative to get access."
          />
        </SettingsLayouts.Body>
      </SettingsLayouts.Root>
    );
