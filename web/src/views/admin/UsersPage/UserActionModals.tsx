  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will no longer be able to join Atez Customs Assistant with this invite.
      </Text>
    </ConfirmationModalLayout>
  );
}
  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will immediately lose access to Atez Customs Assistant. Their sessions
        and agents will be preserved. Their license seat will be freed. You can
  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will regain access to Atez Customs Assistant.
      </Text>
    </ConfirmationModalLayout>
  );
}
  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will be permanently removed from Atez Customs Assistant. All of their
        session history will be deleted. Deletion cannot be undone.
      </Text>
    </ConfirmationModalLayout>
  );
}
