      ...
      <SettingsLayouts.Root>
        ...
        <SettingsLayouts.Body>
          ...
          <Section gap={1}>
            ...
            >
              <InputTextArea
                placeholder="Describe your team and how Atez Customs Assistant should behave."
                rows={4}
                maxRows={10}
                autoResize
                  ...
                  <Section alignItems="stretch">
                    ...
                    >
                      <InputHorizontal
                        ...
                        description="Specify how long Atez Customs Assistant should retain chats in your organization."
                        tag={
                          !enterpriseTier
                            ? {
