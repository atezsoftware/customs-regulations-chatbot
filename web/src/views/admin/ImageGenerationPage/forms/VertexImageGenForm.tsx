        ...
        <FormikField<string>
          ...
          render={(field, helper, _meta, state) => (
            ...
            >
              ...
              <FormField.Message
                messages={{
                  idle: "Choose how Atez Customs Assistant should authenticate with Google Vertex AI.",
                }}
              />
            </FormField>
          )}
          ...
          render={(field, helper, meta, state) => (
            ...
            >
              ...
              {showApiMessage ? (
                ...
                <FormField.Message
                  messages={{
                    idle: "The GCP project where Vertex AI is enabled. Atez Customs Assistant authenticates with the pod's bound service account (GKE Workload Identity).",
                    error: meta.error,
                  }}
                />
              )}
