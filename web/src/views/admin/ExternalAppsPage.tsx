  ...
  return (
    <SettingsLayouts.Root>
      <SettingsLayouts.Header
        ...
        description="Connect third-party integrations so users in your org can authorize them with their personal accounts in Atez Customs Assistant Craft."
        rightChildren={
          <Button
            href="/craft/v1/apps"
...
interface ConfiguredIntegration {
  ...
  edit: (() => void) | null;
  /** Null → not deletable (MCP servers, Atez Customs Assistant-managed apps). */
  remove: {
    run: () => Promise<void>;
    ...
    edit:
      app.app_type === "CUSTOM"
        ...
        : descriptor
          ? () => onEdit(descriptor)
          : null,
    // Atez Customs Assistant-managed built-ins are provisioned by Atez Customs Assistant.
