  ...
  return (
    ...
    >
      <ModalShell provider={provider} isEditing={isEditing}>
        ...
        <ModelSpecFields modelNameSubDescription="A label for this model in Atez Customs Assistant. Azure routes requests by deployment name, so this only needs to be a unique identifier." />
      </ModalShell>
    </Formik>
  );
}
  ...
  return (
    ...
    >
      <ModalShell provider={provider} isEditing={isEditing}>
        ...
        <ModelSpecFields
          modelNameSubDescription={`Atez Customs Assistant will connect to this model on your ${provider.displayName} proxy.`}
        />
      </ModalShell>
    </Formik>
  );
