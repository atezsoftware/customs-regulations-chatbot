...
const CLOUD_TOOLTIP =
  "This setting is managed by Atez Customs Assistant Cloud.";

/**
 * Wrapper that disables its children when either:
 * 1. The app is running on Atez Customs Assistant Cloud (`NEXT_PUBLIC_CLOUD_ENABLED`), or
                    ...
                    <div className="flex w-full flex-col gap-8">
                      ...
                      >
                        <Content
                          ...
                          description="Atez Customs Assistant uses this model to encode documents for search and retrieval."
                          ...
                          <CloudDisabled>
                            <Card border="solid" rounding="lg" padding="sm">
                              <GeneralLayouts.Section padding={0.5}>
                                <Content
                                  icon={SvgVector}
                                  title="Embedding model and settings are managed by Atez Customs Assistant Cloud."
                                  sizePreset="main-ui"
                                  variant="section"
                                />
                              </GeneralLayouts.Section>
