  ...
  return (
    ...
    >
      <ContentAction
        ...
        description="Atez Customs Assistant Craft needs a model provider, and only admins can set one up. Ask your admin to connect Anthropic, OpenAI, or OpenRouter."
        sizePreset="main-ui"
        variant="section"
        padding="lg"
        rightChildren={
