...
> = {
  app: {
    label: "Apps",
    blurb:
      "Integrations Atez Customs Assistant supports directly. Each comes with skills that teach Craft how to use it — start here.",
  ...
  return (
    <SettingsLayouts.Root>
      <SettingsLayouts.Header
        icon={SvgPlug}
        title="Apps"
        description="Connect the tools Atez Customs Assistant Craft can use as context while it works."
        rightChildren={
          isAdmin ? (
            <Button
