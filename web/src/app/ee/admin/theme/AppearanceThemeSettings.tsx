...
>(function AppearanceThemeSettings(
  ...
  return (
    <div className="flex flex-col gap-4 w-full">
        ...
        <div className="flex flex-col gap-4 w-full">
          <FormField state={errors.application_name ? "error" : "idle"}>
            ...
            <FormField.Description>
              This name will show across the app and replace "Atez Customs
              Assistant" in the UI.
            </FormField.Description>
            <FormField.Message
      ...
      >
        <div className="flex gap-2 items-start">
          ...
          >
            ...
            <FormField.Description>
              Add a custom help link in the user menu in addition to the Atez
              Customs Assistant documentation.
            </FormField.Description>
            <FormField.Message
      ...
      <Disabled
        disabled={!enterpriseTier}
        tooltip="Hiding Atez Customs Assistant branding is an Enterprise Plan feature."
      >
        <FormField state="idle" className="gap-0">
          <div className="flex justify-between items-center">
            <FormField.Label>
              Hide Atez Customs Assistant Branding
              {!enterpriseTier && (
                <Tag {...planTagProps("enterprise")} size="sm" />
              )}
            </FormField.Label>
            <FormField.Control>
              <Switch
                aria-label="Hide Atez Customs Assistant Branding"
          ...
          <FormField.Description>
            Remove &ldquo;powered by Atez Customs Assistant&rdquo; and other
            Atez Customs Assistant branding presence in the app.
          </FormField.Description>
        </FormField>
      </Disabled>
