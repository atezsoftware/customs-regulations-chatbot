...
import { CitationChunkMap, CitationMap } from "../../interfaces";
...
export interface FullChatState {
  ...
  /** Human-readable identity persisted on the assistant message. */
  modelDisplayName?: string;
  /** Provider slug for the persisted answer model, used by its provenance chip. */
