  ...
  return (
    <div className="mb-8">
      <p className="mb-2 text-sm text-muted-foreground">
        Setup Slack bots that connect to Atez Customs Assistant. Once setup, you
        will be able to ask questions to Atez Customs Assistant directly from
        Slack. Additionally, you can:
      </p>
      ...
      <p className="mb-6 text-sm text-muted-foreground">
        ...
        found in the Atez Customs Assistant documentation to get started!
      </p>
