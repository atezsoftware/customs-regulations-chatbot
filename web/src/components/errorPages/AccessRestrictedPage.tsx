  ...
  const initialModalMessage = isSeatLimitExceeded
    ...
    : showRenewalMessage
      ? NEXT_PUBLIC_CLOUD_ENABLED
        ? "Your access to Atez Customs Assistant has been temporarily suspended due to a lapse in your subscription."
        : "Your access to Atez Customs Assistant has been temporarily suspended due to a lapse in your license."
      : "An Enterprise license is required to use Atez Customs Assistant. Your data is protected and will be available once a license is activated.";
  ...
  return (
    <ErrorPageLayout>
      ...
      {isSeatLimitExceeded ? (
        ...
        <>
          <Text text03>
            To reinstate your access and continue benefiting from Atez Customs
            Assistant&apos;s powerful features, please update your payment
            information.
          </Text>
        ...
        <>
          <Text text03>
            {hadPreviousLicense
              ? "To reinstate your access and continue using Atez Customs Assistant, please contact your system administrator to renew your license."
