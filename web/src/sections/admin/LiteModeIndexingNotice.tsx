    ...
    <Section padding={2}>
      <IllustrationContent
        ...
        description={markdown(
          `This deployment runs Atez Customs Assistant Lite, which has no vector database — connectors and document indexing are disabled, and nothing is indexed. To connect data sources and index documents, deploy Atez Customs Assistant in **Standard mode**. See the [deployment guide](${DEPLOYMENT_DOCS_URL}) to get started.`
        )}
      />
    </Section>
  );
