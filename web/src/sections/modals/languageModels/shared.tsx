...
/**
 * Sentence appended to an API Base URL `subDescription` when Atez Customs Assistant is detected
 * to be running inside a container — explains why the default uses
 * `host.docker.internal`.
 */
export const CONTAINERIZED_HOST_NOTE =
  "With Atez Customs Assistant running in a container, `host.docker.internal` acts like `localhost` inside the container.";
