    ...
    <div className="z-banner fixed inset-0 bg-background-neutral-01/80">
      <div className="p-2">
        <MessageCard
          ...
          description="If this is your initial setup or you just updated your Atez Customs Assistant deployment, this is likely because the backend is still starting up. Give it a minute or two, and then refresh the page. If that does not work, make sure the backend is setup and/or contact an administrator."
          bottomChildren={
            <div className="px-2">
