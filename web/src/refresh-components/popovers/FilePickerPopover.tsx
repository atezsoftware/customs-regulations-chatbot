...
export default function FilePickerPopover({
  ...
  const { document_import_enabled: uploadsEnabled = true } = useSettings();
    ...
    <>
      ...
      <recentFilesModal.Provider>
        <UserFilesModal
          ...
          description={
            uploadsEnabled
              ? "Upload files or pick from your recent files."
              : "Pick from files already indexed by the importer."
          }
          ...
          handleUploadChange={uploadsEnabled ? handleUploadChange : undefined}
          onView={onFileClick}
